...
Часть 2 - имеется ввиду, что в предыдущем коде будем что то дописывать под
эту главу
...
if __name__ == '__main__':
    ...
    print('после написания isinstance(other, int):', point1+1) # будет корректно работать, если будет isinstance(other, int)
